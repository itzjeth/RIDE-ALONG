...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2024 at 12:16 PM
...
(15, 173, 14505, 'Pending', 'Orders Has Been Received And Is Currently Being Processed', '2024-01-19 14:09:06');
...
('japako', 'jethro', 'jabay', 'japako@gmail.com', '0952103213', '7c090091b3893c6ea5f6168792a6e33c', '', '', '2024-01-19 13:50:37'),
...
--
ALTER TABLE `tblcart`
  MODIFY `SelectionID` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;
...
--
ALTER TABLE `tblorder`
  MODIFY `OrderID` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=174;
