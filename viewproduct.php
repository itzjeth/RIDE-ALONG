    ...
    <div class="col_1">
        ...
        <div class="box2" style="background-color:#FFF;">
            ...
            ?>
                ...
                <a href="viewproduct.php?pid=<?php echo $data['ProductID']; ?>"><input id="similar" type="button" value="See Details"></a>
            <?php } } else { ?>
  ...
  if ($no_of_rows > 0) {
    while ($data = mysqli_fetch_array($single_product)) { ?>
      <div class="col_3">
        ...
        <img id="productimage" src="<?= $data['ProductImage'] ?>" width="370" height="470" alt="<?= $data['ProductName'] ?>">
      </div>
      <div class="col_3">
        ...
        <div class="product_price">
          <span>PHP:<?= $data['ProductPrice'] ?></span>
